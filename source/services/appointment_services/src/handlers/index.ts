...
import { Appointment, HealthCheckRequest, HealthCheckResponse } from '../proto/generated/appointment';
...
export function convertToAppointmentProto(appointment: IAppointment): Appointment {
    return {
        id: appointment.id,
...
export function dateToProtoTimestamp(date?: Date | null) {
    if (!date) {
